...
const rawLog = fs.readFileSync('lint_errors.txt');
let log = rawLog.toString('utf16le');
if (log.indexOf('\u0000') === -1 && log.indexOf('src') === -1) {
    // maybe it IS utf8? Just in case.
    log = rawLog.toString('utf8');
}
