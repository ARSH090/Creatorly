...
export function applyThemeToCSSVars(theme: StorefrontTheme): React.CSSProperties {
    return {
        ...
        '--button': theme.buttonColor || theme.primaryColor,
        '--button-text': theme.buttonTextColor || '#ffffff',
        backgroundColor: theme.backgroundColor,
        color: theme.textColor,
        fontFamily: `'${theme.fontFamily}', system-ui, sans-serif`,
        ...(theme.backgroundImage && {
            backgroundImage: `url(${theme.backgroundImage.startsWith('http') ? theme.backgroundImage : theme.backgroundImage})`,
