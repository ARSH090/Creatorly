...
export const translations = {
  ...
  te: {
    ...
    payment: {
      ...
      total: 'మొత్తం',
      applyCoupon: 'కూపన్‌ను వర్తింపజేయి',
